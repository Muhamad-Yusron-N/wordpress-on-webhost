...
class __TwigTemplate_caa289c795e1eb697be007677cab4c5d extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "newsletter/templates/blocks/posts/settings.hbs", "/opt/lampp/htdocs/wordpress/wp-content/plugins/mailpoet/views/newsletter/templates/blocks/posts/settings.hbs");
    }
}
