...
class __TwigTemplate_eb66d9cb00933333a51f83507873a63f extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "newsletter/templates/blocks/image/settings.hbs", "/opt/lampp/htdocs/wordpress/wp-content/plugins/mailpoet/views/newsletter/templates/blocks/image/settings.hbs");
    }
}
